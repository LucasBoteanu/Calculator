...
btn_set = [[1,ad1,"blue"],[2,ad2,"blue"],[3,ad2,"blue"],["+",adp,"yellow"],
           [4,ad4,"blue"],[5,ad5,"blue"],[6,ad6,"blue"],["-",adm,"yellow"],
           [7,ad7,"blue"],[8,ad8,"blue"],[9,ad9,"blue"],["*",adinm,"yellow"],
           ["%",modulet,"yellow"],[0,ad0,"blue"],["/",adimp,"yellow"],["√",adrad,"yellow"],
...
#set interfata baza>
#set ecran calc
ecr = tk.Entry(root, background="green",foreground="white", borderwidth=1, relief="solid",font=fecr, justify="right")
ecr.insert(0, a)
...
cordy = 50
for n in range(v):
    element = tk.Button(root,text=btn_set[n][0],background=btn_set[n][2],borderwidth=1,relief="solid",font=fecr,justify="right",command=btn_set[n][1])
    if cordx > 225:
        cordy += 50
        cordx = 0
...
#butoane>
#functii grad 2
af = tk.Entry(root, background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
af.place(x=375,y=0,height=50,width=75)
bf = tk.Entry(root, background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
bf.place(x=375,y=50,height=50,width=75)
cf = tk.Entry(root, background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
cf.place(x=375,y=100,height=50,width=75)
av = tk.Label(root,text="a=", background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
av.place(x=300,y=0,height=50,width=75)
bv = tk.Label(root,text="b=", background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
bv.place(x=300,y=50,height=50,width=75)
cv = tk.Label(root,text="c=" ,background="white", borderwidth=1, relief="solid",font=fecr, justify="right")
cv.place(x=300,y=100,height=50,width=75)
but_anal=Button(root,text="=>",background="blue",borderwidth=1,relief="solid",font=fecr,justify="right",command=ecg2)
but_anal.place(x=300,y=150,width=150, height=50)
delt = tk.Label(root,text="", background="white", borderwidth=1,relief="solid",font=fecr,justify="right")
delt.place(x=300,y=200, width= 150, height=50)
xuxd = tk.Label(root,text="", background="white", borderwidth=1,relief="solid",font=fecr1,justify="right")
...
log_inf =tk.Label(root,text="log",font=log_font,justify="right",background="grey")
log_inf.place(x=450,y=0) 
inp_bazalog = tk.Entry(root,background="white",relief="solid",font=fecr,justify="right")
inp_bazalog.place(x=580,y=40,height=30,width=50)
inp_caplog = tk.Entry(root,background="white",borderwidth=1,relief="solid",font=fecr,justify="right")
inp_caplog.place(x=600,y=10,height=30,width=50)
result=tk.Button(root,text="=",font=log_font,justify="right",command=calc,background="grey")
...
#progresii
def calc_prog_ar():
    a1,a2,n = int(inip_prog_aritm_a1.get()),int(inip_prog_aritm_a2.get()),int(inip_prog_aritm_an.get())
    ratiaa = a2-a1
    an = a1 +(n-1)*ratiaa
    rezultat =((a1 + an)*n)/2
...
inip_prog_aritm_a1 = tk.Entry(root,background="white",relief="solid",font=fecr,justify="right")
inip_prog_aritm_a1.place(x=470,y=90 ,width=50,height=50)
simbol_1 = tk.Label(root,background="lightblue",text="+",relief="flat",font=fecr,justify="right")
simbol_1.place(x=520,y=90 ,width=50,height=50)
inip_prog_aritm_a2 = tk.Entry(root,background="white",relief="solid",font=fecr,justify="right")
inip_prog_aritm_a2.place(x=570,y=90 ,width=50,height=50)
simbol_2 = tk.Label(root,background="lightblue",text="+.+",relief="flat",font=fecr,justify="right")
simbol_2.place(x=620,y=90 ,width=50,height=50)
inip_prog_aritm_an = tk.Entry(root,background="white",relief="solid",font=fecr,justify="right")
inip_prog_aritm_an.place(x=670,y=90 ,width=50,height=50)
simbol_3 = tk.Button(root,background="lightblue",text="=",font=fecr,justify="right",command=calc_prog_ar)
simbol_3.place(x=720,y=90 ,width=50,height=50)
raspuns_prog_aritm = tk.Entry(root,background="lightblue",text=a,font=fecr,justify="right")
...
entry_a4 = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
entry_a4.place(x=470, y=150, width=50, height=50)
symbol_multiply_1 = tk.Label(root, background="lightblue", text="*", relief="flat", font=fecr, justify="right")
symbol_multiply_1.place(x=520, y=150, width=50, height=50)
entry_a5 = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
entry_a5.place(x=570, y=150, width=50, height=50)
symbol_multiply_2 = tk.Label(root, background="lightblue", text="*.*", relief="flat", font=fecr, justify="right")
symbol_multiply_2.place(x=620, y=150, width=50, height=50)
entry_an = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
entry_an.place(x=670, y=150, width=50, height=50)
symbol_equal = tk.Button(root, background="lightblue", text="=", font=fecr, justify="right", command=calc_prog_ge)
symbol_equal.place(x=720, y=150, width=50, height=50)
entry_result = tk.Entry(root, background="lightblue", font=fecr, justify="right")
...
inp_med_ar = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
inp_med_ar.place(x=470, y=210, width=50, height=50)
but_med_ar = tk.Button(root, background="lightblue", relief="solid", font=fecr,text="+=", justify="right",command=ad_med_ar)
but_med_ar.place(x=520, y=210, width=50, height=50)
rez_med_ar = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
...
def ad_med_ge():
    ...
    if isinstance(cra, float):
        ...
        print(med_ge_val)
inp_med_ge = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
inp_med_ge.place(x=670, y=210, width=50, height=50)
but_med_ge = tk.Button(root, background="lightblue", relief="solid", font=fecr,text="*=", justify="right",command=ad_med_ge)
but_med_ge.place(x=720, y=210, width=50, height=50)
rez_med_ge = tk.Entry(root, background="white", relief="solid", font=fecr, justify="right")
...
inp_nr_bin = tk.Entry(root, background="white", relief="solid", font=fecr,justify="right")
inp_nr_bin.place(x=450, y= 270,width=100, height=25 )
binary = tk.Button(root,background="lightblue",text="->",relief="solid",font=fecr,justify="right",command=calc_bin)
binary.place(x=550,y=270,height=25,width=25)
ext_nr_bin = tk.Entry(root, background="white", relief="solid", font=fecr,justify="right")
ext_nr_bin.place(x=575, y= 270,width=100, height=25 )
semn_bin = tk.Label(root, background="lightblue", relief="flat", font=fecr,justify="right",text="bin")
...
trigo_btn= tk.Button(root,relief="solid",background="red",font=fecr,text="=>",command=calc_tringo)
